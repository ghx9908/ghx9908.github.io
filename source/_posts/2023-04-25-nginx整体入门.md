...
2. ` vim keepalived.conf` 配置nginx双活热备（同一网段）
...
[nginx安全认证中文介绍](https://blog.redis.com.cn/doc/standard/httpauthbasic.html)

[htpasswd相关介绍](https://www.cnblogs.com/Chilam007/p/16900400.html)

1. htpasswd生成密码文件

   ` yum install httpd-tools -y`

2. htpasswd生成nginx密码文件(用户名不要使用user_password)
